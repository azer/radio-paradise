...
var _azer$radio_paradise$History_Types$Song = F2(
	function (a, b) {
		return {artist: a, title: b};
	});
var _azer$radio_paradise$History_Types$Model = F3(
	function (a, b, c) {
		return {history: a, popular: b, error: c};
	});
var _azer$radio_paradise$History_Types$APIResponse = F2(
	function (a, b) {
		return {nowplaying: a, popular: b};
	});
var _azer$radio_paradise$History_Types$RequestHistoryMsg = function (a) {
	return {ctor: 'RequestHistoryMsg', _0: a};
};
var _azer$radio_paradise$History_Types$HistoryLoadedMsg = function (a) {
	return {ctor: 'HistoryLoadedMsg', _0: a};
};
...
var _azer$radio_paradise$Player_Types$File = F3(
	function (a, b, c) {
		return {format: a, quality: b, url: c};
	});
var _azer$radio_paradise$Player_Types$Model = F5(
	function (a, b, c, d, e) {
		return {idle: a, muted: b, loading: c, sources: d, error: e};
	});
var _azer$radio_paradise$Player_Types$KeyMsg = function (a) {
	return {ctor: 'KeyMsg', _0: a};
};
var _azer$radio_paradise$Player_Types$ErrorMsg = {ctor: 'ErrorMsg'};
var _azer$radio_paradise$Player_Types$LoadingMsg = {ctor: 'LoadingMsg'};
var _azer$radio_paradise$Player_Types$PauseMsg = {ctor: 'PauseMsg'};
var _azer$radio_paradise$Player_Types$PlayMsg = {ctor: 'PlayMsg'};
var _azer$radio_paradise$Player_Types$ToggleMsg = {ctor: 'ToggleMsg'};
var _azer$radio_paradise$Player_Types$UnmuteMsg = {ctor: 'UnmuteMsg'};
var _azer$radio_paradise$Player_Types$MuteMsg = {ctor: 'MuteMsg'};

var _azer$radio_paradise$Wallpaper_Types$File = F2(
	function (a, b) {
		return {size: a, url: b};
	});
var _azer$radio_paradise$Wallpaper_Types$Image = F2(
	function (a, b) {
		return {position: a, sources: b};
	});
var _azer$radio_paradise$Wallpaper_Types$Model = F2(
	function (a, b) {
		return {image: a, error: b};
	});

var _azer$radio_paradise$Container_Types$Model = F3(
	function (a, b, c) {
		return {history: a, player: b, wallpaper: c};
	});
var _azer$radio_paradise$Container_Types$PlayerMsg = function (a) {
	return {ctor: 'PlayerMsg', _0: a};
};
var _azer$radio_paradise$Container_Types$HistoryMsg = function (a) {
	return {ctor: 'HistoryMsg', _0: a};
};

var _azer$radio_paradise$History_Rest$songDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_azer$radio_paradise$History_Types$Song,
	A2(_elm_lang$core$Json_Decode$field, 'artist', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string));
var _azer$radio_paradise$History_Rest$responseDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_azer$radio_paradise$History_Types$APIResponse,
	A2(
		_elm_lang$core$Json_Decode$field,
		'nowplaying',
		_elm_lang$core$Json_Decode$list(_azer$radio_paradise$History_Rest$songDecoder)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'popular',
		_elm_lang$core$Json_Decode$list(_azer$radio_paradise$History_Rest$songDecoder)));
var _azer$radio_paradise$History_Rest$requestLatestHistory = A2(
	_elm_lang$http$Http$send,
	_azer$radio_paradise$History_Types$HistoryLoadedMsg,
	A2(_elm_lang$http$Http$get, '/api/now', _azer$radio_paradise$History_Rest$responseDecoder));

var _azer$radio_paradise$History_State$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 10, _azer$radio_paradise$History_Types$RequestHistoryMsg);
};
var _azer$radio_paradise$History_State$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'RequestHistoryMsg') {
			return {ctor: '_Tuple2', _0: model, _1: _azer$radio_paradise$History_Rest$requestLatestHistory};
		} else {
			if (_p0._0.ctor === 'Ok') {
				var _p1 = _p0._0._0;
				return {
					ctor: '_Tuple2',
					_0: A3(_azer$radio_paradise$History_Types$Model, _p1.nowplaying, _p1.popular, ''),
...
var _azer$radio_paradise$History_State$init = {
	ctor: '_Tuple2',
	_0: A3(
		_azer$radio_paradise$History_Types$Model,
		{ctor: '[]'},
		{ctor: '[]'},
		''),
	_1: A2(_elm_lang$core$Task$perform, _azer$radio_paradise$History_Types$RequestHistoryMsg, _elm_lang$core$Time$now)
};

var _azer$radio_paradise$Player_State$subscriptions = function (model) {
	return _elm_lang$keyboard$Keyboard$downs(_azer$radio_paradise$Player_Types$KeyMsg);
};
var _azer$radio_paradise$Player_State$sources = {
	ctor: '::',
	_0: A3(_azer$radio_paradise$Player_Types$File, 'audio/mp3', 192, 'http://stream-tx4.radioparadise.com/mp3-192'),
	_1: {
		ctor: '::',
		_0: A3(_azer$radio_paradise$Player_Types$File, 'audio/ogg', 192, 'http://stream-tx4.radioparadise.com/ogg-192'),
		_1: {
			ctor: '::',
			_0: A3(_azer$radio_paradise$Player_Types$File, 'audio/aac', 128, 'http://stream-tx4.radioparadise.com/aac-128'),
			_1: {ctor: '[]'}
		}
	}
};
var _azer$radio_paradise$Player_State$init = {
	ctor: '_Tuple2',
	_0: A5(_azer$radio_paradise$Player_Types$Model, true, false, true, _azer$radio_paradise$Player_State$sources, ''),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _azer$radio_paradise$Player_State$setAsMuted = _elm_lang$core$Native_Platform.outgoingPort(
	'setAsMuted',
	function (v) {
		return v;
	});
var _azer$radio_paradise$Player_State$forcePlay = _elm_lang$core$Native_Platform.outgoingPort(
	'forcePlay',
	function (v) {
		return v;
	});
var _azer$radio_paradise$Player_State$update = F2(
	function (msg, model) {
		var _p0 = A2(_elm_lang$core$Debug$log, '[player]', msg);
		switch (_p0.ctor) {
			case 'ToggleMsg':
				return model.idle ? {
					ctor: '_Tuple2',
					_0: model,
					_1: _azer$radio_paradise$Player_State$forcePlay(true)
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{muted: !model.muted}),
					_1: _azer$radio_paradise$Player_State$setAsMuted(!model.muted)
				};
			case 'PlayMsg':
				return {
					ctor: '_Tuple2',
			...
			case 'MuteMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{muted: true}),
					_1: _azer$radio_paradise$Player_State$setAsMuted(true)
				};
			case 'UnmuteMsg':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{muted: false}),
					_1: _azer$radio_paradise$Player_State$setAsMuted(false)
				};
			case 'LoadingMsg':
				return {
					ctor: '_Tuple2',
			...
			default:
				return _elm_lang$core$Native_Utils.eq(_p0._0, 32) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{muted: !model.muted}),
...
var _azer$radio_paradise$Wallpaper_State$sahara = A2(
	_azer$radio_paradise$Wallpaper_Types$Image,
	'center bottom',
	{
		ctor: '::',
		_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 640, 'https://c1.staticflickr.com/5/4505/36821546343_9d1f087a58_z.jpg'),
		_1: {
			ctor: '::',
			_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 800, 'https://c1.staticflickr.com/5/4505/36821546343_9d1f087a58_c.jpg'),
			_1: {
				ctor: '::',
				_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 1024, 'https://c1.staticflickr.com/5/4505/36821546343_9d1f087a58_b.jpg'),
				_1: {
					ctor: '::',
					_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 1600, 'https://c1.staticflickr.com/5/4505/36821546343_5c7bd29631_h.jpg'),
					_1: {
						ctor: '::',
						_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 2048, 'https://c1.staticflickr.com/5/4505/36821546343_3c14e47733_k.jpg'),
						_1: {
							ctor: '::',
							_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 5212, 'https://c1.staticflickr.com/5/4505/36821546343_51e0e4d3db_o.jpg'),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _azer$radio_paradise$Wallpaper_State$init = A2(_azer$radio_paradise$Wallpaper_Types$Model, _azer$radio_paradise$Wallpaper_State$sahara, '');
var _azer$radio_paradise$Wallpaper_State$pointreyes = A2(
	_azer$radio_paradise$Wallpaper_Types$Image,
	'center',
	{
		ctor: '::',
		_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 640, 'https://c1.staticflickr.com/5/4493/37431826436_ceccd9f535_z.jpg'),
		_1: {
			ctor: '::',
			_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 800, 'https://c1.staticflickr.com/5/4493/37431826436_ceccd9f535_c.jpg'),
			_1: {
				ctor: '::',
				_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 1024, 'https://c1.staticflickr.com/5/4493/37431826436_ceccd9f535_b.jpg'),
				_1: {
					ctor: '::',
					_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 1600, 'https://c1.staticflickr.com/5/4493/37431826436_fd71503889_h.jpg'),
					_1: {
						ctor: '::',
						_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 3000, 'https://c1.staticflickr.com/5/4493/37431826436_8e42d288d4_k.jpg'),
						_1: {
							ctor: '::',
							_0: A2(_azer$radio_paradise$Wallpaper_Types$File, 5212, 'https://c1.staticflickr.com/5/4493/37431826436_cce0de098f_o.jpg'),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _azer$radio_paradise$Container_State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(
				_elm_lang$core$Platform_Sub$map,
				_azer$radio_paradise$Container_Types$HistoryMsg,
				_azer$radio_paradise$History_State$subscriptions(model.history)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Sub$map,
					_azer$radio_paradise$Container_Types$PlayerMsg,
					_azer$radio_paradise$Player_State$subscriptions(model.player)),
				_1: {ctor: '[]'}
			}
		});
};
var _azer$radio_paradise$Container_State$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'HistoryMsg') {
			var _p1 = A2(_azer$radio_paradise$History_State$update, _p0._0, model.history);
			var history = _p1._0;
			var historyCmd = _p1._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{history: history}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _azer$radio_paradise$Container_Types$HistoryMsg, historyCmd)
			};
		} else {
			var _p2 = A2(_azer$radio_paradise$Player_State$update, _p0._0, model.player);
			var player = _p2._0;
			var playerCmd = _p2._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{player: player}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _azer$radio_paradise$Container_Types$PlayerMsg, playerCmd)
			};
		}
	});
var _azer$radio_paradise$Container_State$init = function () {
	var wallpaper = _azer$radio_paradise$Wallpaper_State$init;
	var _p3 = _azer$radio_paradise$Player_State$init;
	var player = _p3._0;
	var playerCmd = _p3._1;
	var _p4 = _azer$radio_paradise$History_State$init;
	var history = _p4._0;
	var historyCmd = _p4._1;
	return {
		ctor: '_Tuple2',
		_0: A3(_azer$radio_paradise$Container_Types$Model, history, player, wallpaper),
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _azer$radio_paradise$Container_Types$HistoryMsg, historyCmd),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _azer$radio_paradise$Container_Types$PlayerMsg, playerCmd),
					_1: {ctor: '[]'}
				}
			})
	};
...
var _azer$radio_paradise$History_View$nowPlayingRowStyle = {
	ctor: '::',
...
var _azer$radio_paradise$History_View$rowStyle = {
	ctor: '::',
...
var _azer$radio_paradise$History_View$tableStyle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _azer$radio_paradise$History_View$contentStyle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '100px 0 0 140px'),
		_1: {
			ctor: '::',
			_0: A2(
				_rtfeldman$elm_css$Css_Media$withMedia,
				...
				{
					ctor: '::',
					_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '0 0 0 50px'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
	});
var _azer$radio_paradise$History_View$songsStyle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '100px 0 0 0'),
		_1: {
			ctor: '::',
			_0: A2(
				_rtfeldman$elm_css$Css_Media$withMedia,
				...
				{
					ctor: '::',
					_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '50px 0 0 0'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
	});
var _azer$radio_paradise$History_View$historyStyle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _azer$radio_paradise$History_View$titleStyle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$fontSize(
			_rtfeldman$elm_css$Css$px(18)),
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '0 0 5px 0'),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$padding(
									_rtfeldman$elm_css$Css$px(0)),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$color(
										A4(_rtfeldman$elm_css$Css$rgba, 255, 255, 255, 0.3)),
									_1: {
										ctor: '::',
										_0: A2(
											_rtfeldman$elm_css$Css_Media$withMedia,
...
var _azer$radio_paradise$History_View$footerStyle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$fontSize(
			_rtfeldman$elm_css$Css$px(14)),
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$color(
									A4(_rtfeldman$elm_css$Css$rgba, 255, 255, 255, 0.4)),
								_1: {
									ctor: '::',
									_0: A2(
										_rtfeldman$elm_css$Css_Media$withMedia,
...
var _azer$radio_paradise$History_View$link = F2(
	function (url, label) {
		return A2(
...
var _azer$radio_paradise$History_View$viewFooter = A2(
	_rtfeldman$elm_css$Html_Styled$h2,
	{
		ctor: '::',
		_0: _azer$radio_paradise$History_View$footerStyle,
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: A2(_azer$radio_paradise$History_View$link, 'http://kodfabrik.com', 'Webmaster'),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text('>'),
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(_azer$radio_paradise$History_View$link, 'http://kodfabrik.com/photo/36821546343', 'Photo'),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('>'),
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_azer$radio_paradise$History_View$link, 'http://radioparadise.com', 'RP'),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled$text('>'),
										_1: {
											...
											_1: {
												ctor: '::',
												_0: A2(_azer$radio_paradise$History_View$link, 'https://github.com/azer/radio-paradise', 'CODE'),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Html_Styled$text('>'),
													_1: {ctor: '[]'}
...
var _azer$radio_paradise$History_View$viewSong = F2(
	function (customStyle, song) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$li,
			{
				...
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$batch(_azer$radio_paradise$History_View$rowStyle),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$batch(customStyle),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
			},
			{
				...
				_0: _rtfeldman$elm_css$Html_Styled$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						song.artist,
						A2(_elm_lang$core$Basics_ops['++'], ' — ', song.title))),
				_1: {ctor: '[]'}
			});
	});
var _azer$radio_paradise$History_View$viewSongs = F3(
	function (title, songs, customStyle) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				_0: _azer$radio_paradise$History_View$songsStyle,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _azer$radio_paradise$History_View$titleStyle,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _azer$radio_paradise$History_View$tableStyle,
							_1: {ctor: '[]'}
						},
						A2(
							_elm_lang$core$List$map,
							_azer$radio_paradise$History_View$viewSong(customStyle),
							songs)),
					_1: {ctor: '[]'}
				}
			});
	});
var _azer$radio_paradise$History_View$view = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _azer$radio_paradise$History_View$historyStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _azer$radio_paradise$History_View$contentStyle,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A3(_azer$radio_paradise$History_View$viewSongs, 'Now Playing', model.history, _azer$radio_paradise$History_View$nowPlayingRowStyle),
					_1: {
						ctor: '::',
						_0: A3(
							_azer$radio_paradise$History_View$viewSongs,
							'Popular',
							A2(_elm_lang$core$List$take, 5, model.popular),
							{ctor: '[]'}),
						_1: {
							ctor: '::',
							_0: _azer$radio_paradise$History_View$viewFooter,
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _azer$radio_paradise$Player_Events$onCanPlayThrough = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled_Events$on,
		'canplaythrough',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _azer$radio_paradise$Player_Events$onStalled = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled_Events$on,
		'stalled',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _azer$radio_paradise$Player_Events$onError = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled_Events$on,
		'error',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _azer$radio_paradise$Player_Events$onSeeking = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled_Events$on,
		'seeking',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _azer$radio_paradise$Player_Events$onSuspend = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled_Events$on,
		'suspend',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _azer$radio_paradise$Player_Events$onEnd = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled_Events$on,
		'ended',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _azer$radio_paradise$Player_Events$onPaused = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled_Events$on,
		'paused',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _azer$radio_paradise$Player_Events$onPause = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled_Events$on,
		'pause',
		_elm_lang$core$Json_Decode$succeed(message));
};
var _azer$radio_paradise$Player_Events$onPlay = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled_Events$on,
		'play',
		_elm_lang$core$Json_Decode$succeed(message));
...
var _azer$radio_paradise$Player_Icons$spinner = A2(
	_rtfeldman$elm_css$Svg_Styled$svg,
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Svg_Styled_Attributes$width('32px'),
		_1: {
			ctor: '::',
			_0: _rtfeldman$elm_css$Svg_Styled_Attributes$height('32px'),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Svg_Styled_Attributes$viewBox('0 0 40 40'),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Svg_Styled_Attributes$enableBackground('new 0 0 32 32'),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Svg_Styled_Attributes$x('0px'),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Svg_Styled_Attributes$y('0px'),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Svg_Styled_Attributes$opacity('0.2'),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Svg_Styled_Attributes$fill('#fff'),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Svg_Styled_Attributes$d('M20.201,5.169c-8.254,0-14.946,6.692-14.946,14.946c0,8.255,6.692,14.946,14.946,14.946 s14.946-6.691,14.946-14.946C35.146,11.861,28.455,5.169,20.201,5.169z M20.201,31.749c-6.425,0-11.634-5.208-11.634-11.634 c0-6.425,5.209-11.634,11.634-11.634c6.425,0,11.633,5.209,11.633,11.634C31.834,26.541,26.626,31.749,20.201,31.749z'),
						_1: {ctor: '[]'}
					}
				}
			},
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Svg_Styled$path,
				{
					...
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Svg_Styled_Attributes$d('M26.013,10.047l1.654-2.866c-2.198-1.272-4.743-2.012-7.466-2.012h0v3.312h0 C22.32,8.481,24.301,9.057,26.013,10.047z'),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: A2(
						_rtfeldman$elm_css$Svg_Styled$animateTransform,
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Svg_Styled_Attributes$attributeType('xml'),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Svg_Styled_Attributes$attributeName('transform'),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Svg_Styled_Attributes$type_('rotate'),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Svg_Styled_Attributes$from('0 20 20'),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Svg_Styled_Attributes$to('360 20 20'),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Svg_Styled_Attributes$dur('0.5s'),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Svg_Styled_Attributes$repeatCount('indefinite'),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _azer$radio_paradise$Player_Icons$play = function (size) {
	return A2(
		_rtfeldman$elm_css$Svg_Styled$svg,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Svg_Styled_Attributes$width(
				_elm_lang$core$Basics$toString(size)),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Svg_Styled_Attributes$height(
					_elm_lang$core$Basics$toString(size)),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Svg_Styled_Attributes$viewBox('0 0 1200 1200'),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			...
			_0: A2(
				_rtfeldman$elm_css$Svg_Styled$path,
				{
					...
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Svg_Styled_Attributes$opacity('0.9'),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Svg_Styled_Attributes$d('M 600,1200 C 268.65,1200 0,931.35 0,600 0,268.65 268.65,0 600,0 c 331.35,0 600,268.65 600,600 0,331.35 -268.65,600 -600,600 z M 450,300.45 450,899.55 900,600 450,300.45 z'),
							_1: {ctor: '[]'}
						}
					}
				},
			...
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Svg_Styled$text(''),
				_1: {ctor: '[]'}
			}
		});
};
var _azer$radio_paradise$Player_Icons$icon = F2(
	function (size, data) {
		var w = _elm_lang$core$Basics$toString(size);
		return A2(
			_rtfeldman$elm_css$Svg_Styled$svg,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Svg_Styled_Attributes$width(w),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Svg_Styled_Attributes$height(w),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Svg_Styled_Attributes$viewBox('0 0 32 32'),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Svg_Styled_Attributes$fill('none'),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Svg_Styled_Attributes$stroke('currentColor'),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Svg_Styled_Attributes$strokeLinecap('round'),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Svg_Styled_Attributes$strokeLinejoin('round'),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Svg_Styled_Attributes$strokeWidth('2'),
											_1: {ctor: '[]'}
										}
									}
								}
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Svg_Styled_Attributes$d(data),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
...
var _azer$radio_paradise$Player_Icons$play_ = function (size) {
	return A2(_azer$radio_paradise$Player_Icons$icon, size, 'M10 2 L10 30 24 16 Z');
};
var _azer$radio_paradise$Player_Icons$volume = function (size) {
	return A2(_azer$radio_paradise$Player_Icons$icon, size, 'M20 16 C20 8 15 2 15 2 L8 10 2 10 2 22 8 22 15 30 C15 30 20 24 20 16 Z M21 2 C21 2 25 6 25 16 25 26 21 30 21 30 M27 4 C27 4 30 8 30 16 30 24 27 28 27 28');
};
var _azer$radio_paradise$Player_Icons$mute = function (size) {
	return A2(_azer$radio_paradise$Player_Icons$icon, size, 'M20 16 C20 8 15 2 15 2 L8 10 2 10 2 22 8 22 15 30 C15 30 20 24 20 16 Z');
};

var _azer$radio_paradise$Player_View$playerStyle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$block),
		_1: {
...
var _azer$radio_paradise$Player_View$viewSource = function (file) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$source,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$src(file.url),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$type_(file.format),
				_1: {ctor: '[]'}
			}
		},
		{ctor: '[]'});
};
var _azer$radio_paradise$Player_View$viewButton = function (model) {
	return model.idle ? _azer$radio_paradise$Player_Icons$play(32) : (model.loading ? _azer$radio_paradise$Player_Icons$spinner : (model.muted ? _azer$radio_paradise$Player_Icons$mute(32) : _azer$radio_paradise$Player_Icons$volume(32)));
};
var _azer$radio_paradise$Player_View$viewAudio = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$audio,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$controls(false),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$autoplay(false),
				_1: {
					ctor: '::',
					_0: _azer$radio_paradise$Player_Events$onPlay(_azer$radio_paradise$Player_Types$PlayMsg),
					_1: {
						ctor: '::',
						_0: _azer$radio_paradise$Player_Events$onPause(_azer$radio_paradise$Player_Types$PauseMsg),
						_1: {
							ctor: '::',
							_0: _azer$radio_paradise$Player_Events$onEnd(_azer$radio_paradise$Player_Types$PauseMsg),
							_1: {
								ctor: '::',
								_0: _azer$radio_paradise$Player_Events$onSuspend(_azer$radio_paradise$Player_Types$PauseMsg),
								_1: {
									ctor: '::',
									_0: _azer$radio_paradise$Player_Events$onStalled(_azer$radio_paradise$Player_Types$LoadingMsg),
									_1: {
										ctor: '::',
										_0: _azer$radio_paradise$Player_Events$onError(_azer$radio_paradise$Player_Types$ErrorMsg),
										_1: {ctor: '[]'}
									}
								}
							}
		...
		A2(_elm_lang$core$List$map, _azer$radio_paradise$Player_View$viewSource, model.sources));
};
var _azer$radio_paradise$Player_View$view = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_azer$radio_paradise$Player_Types$ToggleMsg),
			_1: {
				ctor: '::',
				_0: _azer$radio_paradise$Player_View$playerStyle,
				_1: {ctor: '[]'}
			}
		},
		{
			ctor: '::',
			_0: _azer$radio_paradise$Player_View$viewAudio(model),
			_1: {
				ctor: '::',
				_0: _azer$radio_paradise$Player_View$viewButton(model),
				_1: {ctor: '[]'}
			}
		});
};

var _azer$radio_paradise$Wallpaper_View$imageStyle = function (source) {
	return A2(
		_rtfeldman$elm_css$Css_Media$withMedia,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Css_Media$all(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css_Media$maxWidth(
						_rtfeldman$elm_css$Css$px(source.size)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: _rtfeldman$elm_css$Css$backgroundImage(
				_rtfeldman$elm_css$Css$url(source.url)),
			_1: {ctor: '[]'}
		});
};
var _azer$radio_paradise$Wallpaper_View$viewStyle = function (image) {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: A2(_rtfeldman$elm_css$Css$property, 'background-position', image.position),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$zIndex(
												...
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$batch(
														A2(_elm_lang$core$List$map, _azer$radio_paradise$Wallpaper_View$imageStyle, image.sources)),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _azer$radio_paradise$Wallpaper_View$view = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _azer$radio_paradise$Wallpaper_View$viewStyle(model.image),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
};

var _azer$radio_paradise$Container_View$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_rtfeldman$elm_css$Html_Styled$toUnstyled(
					_azer$radio_paradise$History_View$view(model.history))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$map,
					_azer$radio_paradise$Container_Types$PlayerMsg,
					_rtfeldman$elm_css$Html_Styled$toUnstyled(
						_azer$radio_paradise$Player_View$view(model.player))),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled$toUnstyled(
						_azer$radio_paradise$Wallpaper_View$view(model.wallpaper)),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _azer$radio_paradise$App$main = _elm_lang$html$Html$program(
	{init: _azer$radio_paradise$Container_State$init, view: _azer$radio_paradise$Container_View$view, update: _azer$radio_paradise$Container_State$update, subscriptions: _azer$radio_paradise$Container_State$subscriptions})();

var Elm = {};
Elm['App'] = Elm['App'] || {};
if (typeof _azer$radio_paradise$App$main !== 'undefined') {
    _azer$radio_paradise$App$main(Elm['App'], 'App', undefined);
}
